                ...
                <div class="sub-body">
                    <div class="sub-headline">
                        ...
                        <div class="sub-text">
                            ...
                            <% ArrayList<LicenseDTO> licenseList = (ArrayList<LicenseDTO>)session.getAttribute("licenseList"); %>
                            <% if (licenseList != null){;%>
                            <p style="font-size: 20px;"> <%=licenseList.get(0).getField() %>권에서 선호하는 자격증입니다.</p> <br>
                            <p style="font-size: 20px;"> 당신의 꿈을 응원합니다!</p> 
                            <%}else{ %>
                            <p style="font-size: 20px;"> 자격증을 입력해주세요.</p> 
                            <%} %>
                        </div>           
                        ...
                        <div style="margin-top: 300px; margin-right: 150px;">
                            ...
                            <div style="border: 5px solid white; padding: 0 30px 30px 30px;">
                                <div id="comp-il9my3zy2" class="_2bafp" data-testid="richTextElement" style=" margin-bottom: 40px; margin-top: 25px;">
                                    <h3 class="font_3" style="font-size:30px;"><%=licenseList.get(0).getName() %></h3>
                                </div>                            
                                <div id="comp-is5s14p6" class="_2bafp" data-testid="richTextElement" style="width:400px; height:150px;">
                                    <div class="font_8"><p style="font-size:18px; color:gray; "><%=licenseList.get(0).getContent() %></p></div>
                                    <p class="font_8" style="line-height:em;font-size:18px"><%=licenseList.get(0).getTerms() %></p>
                                </div>
                                <a href="https://www.naver.com" class="btn-pr"><%=licenseList.get(0).getLink() %><img src="public/images/common/arrow-up2.svg" alt="화살" class="updown svg"></a>    
                            </div>
                        </div>
                        ...
                        <div style="margin-top: 300px;">
                            ...
                            <div style="border: 5px solid white; padding: 0 30px 30px 30px;">
                                <div id="comp-il9my3zy2" class="_2bafp" data-testid="richTextElement" style=" margin-bottom: 40px; margin-top: 25px;">
                                    <h3 class="font_3" style="font-size:30px;"><%=licenseList.get(1).getName() %></h3>
                                </div>                            
                                <div id="comp-is5s14p6" class="_2bafp" data-testid="richTextElement" style="width:400px; height:150px;">
                                    <div class="font_8"><p style="font-size:18px; color:gray; "><%=licenseList.get(1).getContent() %></p></div>
                                    <p class="font_8" style="line-height:em;font-size:18px"><%=licenseList.get(1).getTerms() %></p>
                                </div>
                                <a href="https://www.naver.com" class="btn-pr"><%=licenseList.get(1).getLink() %><img src="public/images/common/arrow-up2.svg" alt="화살" class="updown svg"></a>    
                            </div>
                        </div>
                        ...
                        <div style="margin-top: 300px; margin-left: 150px;">
                            ...
                            <div style="border: 5px solid white; padding: 0 30px 30px 30px;">
                                <div id="comp-il9my3zy2" class="_2bafp" data-testid="richTextElement" style=" margin-bottom: 40px; margin-top: 25px;">
                                    <h3 class="font_3" style="font-size:30px;"><%=licenseList.get(2).getName() %></h3>
                                </div>                            
                                <div id="comp-is5s14p6" class="_2bafp" data-testid="richTextElement" style="width:400px; height:150px;">
                                    <div class="font_8"><p style="font-size:18px; color:gray; "><%=licenseList.get(2).getContent() %></p></div>
                                    <p class="font_8" style="line-height:em;font-size:18px"><%=licenseList.get(2).getTerms() %></p>
                                </div>
                                <a href="https://www.naver.com" class="btn-pr"><%=licenseList.get(2).getLink() %><img src="public/images/common/arrow-up2.svg" alt="화살" class="updown svg"></a>    
                            </div>
                        </div>
                        <%} %>
