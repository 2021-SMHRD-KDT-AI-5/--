...
<!-- Basic Jquery -->
<script src="http://cdnjs.cloudflare.com/ajax/libs/babel-standalone/6.26.0/babel.min.js" integrity="sha256-FiZMk1zgTeujzf/+vomWZGZ9r00+xnGvOgXoj0Jo1jA=" crossorigin="anonymous"></script>
...
<!-- 다음 카카오 -->
<script type="text/javascript" charset="UTF-8" src="http://t1.daumcdn.net/adfit/static/kp.js"></script>
...
<div id="myContainer" class="cont-sub cont-contact">
         ...
         <div id="contact1" class="subwrap">
            <div class="sub-body">
               <div class="sub-headline">
                        ...
                        <button class="main-button sub-button sub-button1 xalign" style="left : 60%;" onclick="location.href='contact.jsp#secondPage' ">
                            <span class="text xalign">LOGIN<br><br>하러가기</span>
                            <span class="gooey"></span>
                        </button>

                        <button class="main-button sub-button sub-button1 xalign" style="left : 40%;" onclick="location.href='contact.jsp#3rdPage' ">
                            <span class="text xalign">JOIN<br><br>하러가기</span>
                            <span class="gooey"></span>
                        </button>
                    </div>
                    <svg viewBox="0 0 100 100" class="circle-svg">
                        <!-- The SVG size is related to 'viewBox' size (%). -->
                        <circle id="circle" cx="50" cy="50" r="25" />
                    </svg>
            </div><!-- // sub-body --->
         </div><!-- //// about --->
      </div>
    ...
    <div class="section section2">
        <div class="slide">
            <div id="contact2" class="subwrap">
                <div class="sub-body">
                    <div class="sub-table">
                        <div class="txtarea yalign">
                            <span class="sect-tit1" lang="en" style="font-size: 50px; margin-bottom: 100px;">LOGIN</span>
                            <form action="../LoginCon.do" method="POST"> 
                                ...
                                <div>
	                                <button type="submit" class="main-button sub-button sub-button2" style="margin-top: 30%;" >
	                                <span class="text xalign" style="font-size: 25px;">LOGIN</span>
	                                <span class="gooey"></span>
	                            	</button>
                            	</div> 
                            </form>
                        ...
                        <div class="ai">
                            <span class="ai-img" style="background-image:url('public/images/sub/svs3_0.svg')" alt="일러스트"></span>
                        </div>
                        <div class="ai-mobile">
                            <img class="ai-mobile-img" src="public/images/sub/svs3_0_m.svg" class="ai-mobile-img" alt="일러스트">
                        </div>                        
                        <span class="bg-gooey">
                            <!-- <img src="/public/images/sub/svs3_bg1.svg" alt="백그라운드"> -->
                            <svg xmlns="http://www.w3.org/2000/svg" width="852" height="821" viewBox="0 0 852 821">
                                <defs>
                                    <style>.svs3_bg1{fill:#ffcda8;}</style>
                                </defs>
                                <path class="svs3_bg1">
                                    <animate repeatCount="indefinite" attributeName="d" dur="10s" 
                                    values="M285.3,803.5C196.217,760.684,133.894,678.3,89.941,581.2,43.621,478.862,17.857,360.073,2.9,254.6-18.092,106.351,76.255,31.736,207.252,8.347,297.431-7.754,404.791.291,504.1,25.2,609.02,51.516,696.614,92.254,757.458,149.546,838.307,225.674,872.213,330.95,837.5,470.6c-32.3,129.9-141,200.6-249.8,259.5C491.3,782.3,391.9,854.7,285.3,803.5Z;

                                    M285.3,803.5c-89.083-42.816-173.375-83.4-217.328-180.505C21.652,520.658,17.857,360.073,2.9,254.6-18.092,106.351,98.975,58.384,229.972,34.995c90.179-16.1,172.691-42.909,272-18,104.92,26.316,91.156,146.708,152,204C734.821,297.123,872.213,330.95,837.5,470.6c-32.3,129.9-74.728,207.495-183.528,266.395C557.572,789.195,391.9,854.7,285.3,803.5Z;
    ...
    <div class="section section3">
        <div class="slide">
            <div id="contact3" class="subwrap">
                <div class="sub-body">
                    <div class="sub-table">
                        <div class="txtarea yalign">
                            <!--<span class="sect-tit1" lang="en">Request Project</span>-->
                            <span class="sect-tit1" lang="en" style="font-size: 50px; margin-bottom: 100px;">JOIN</span>
                            <div class="article">
                                
                                <a href="javascript:void(0);" class="request-btn aniswing">회원가입 →</a>
                            </div>
                            <form action="../joinCon.do" name="contact_form" id="contact_form" onsubmit="return false" method="post"
                             accept-charset="utf-8">
                                <input type="hidden" name="csrf_test_name" value="119184e50aba5f574758028d9c534c32" />
                                <input type="hidden" name="post_title" value="" />
                                <input type="hidden" name="csrf_test_name" value="119184e50aba5f574758028d9c534c32" />
                                <div class="article-form">
                                    <div class="wf-form input_div" data-name="wf_company_name" id="wf_company_name">
                                        이메일은 <input type="text" name="email" class="default" autocomplete="off"> 이고,
                                    </div>
                                    <div class="wf-form input_div" data-name="wf_nickname" id="wf_nickname">
                                        닉네임은 <input type="text" name="nickname" class="default" autocomplete="off"> 이고,
                                    </div>
                                    <div class="wf-form input_div" data-name="wf_tel" id="wf_tel">
                                        연락처는 <input type="text" name="tel" class="default" autocomplete="off" numberOnly> 입니다.
                                    </div>
                                    <div class="wf-form input_div" data-name="wf_email" id="wf_email" >
                                        비밀번호는 <input type="password" name="pw" class="default" autocomplete="off"> 로 할게요!
                                    </div>                                    
                                        <div class="wf-form input_div" data-name="wf_content" id="wf_content">
                                            가입 목적은 다음과 같아요
                                            <div class="textarea-wrap">
                                                <textarea name="post_content" id="post_content" cols="5000" rows="4" class="default"></textarea>
                                            </div>
                                        </div>  
                                </div>                           
                                    <div class="articel-agree" data-name="agree" id="agree">
                                        <div class="toggle">                                                                                  
                                            <span class="agree-text">개인정보 수집과 이용에 동의할게요!</span> 
                                            <input type="checkbox" name="agree" class="check-checkbox" id="mytoggle" value="y">
                                    ...
                                    <div>
	                                    <button type="submit" class="main-button sub-button sub-button2" id="btn_submit" style="display:none;margin-top: 60%;">
	                                        <span class="text xalign">Join</span>
	                                        <span class="arrow xalign" style="transform: rotate(-135deg);-webkit-transform: rotate(-135deg);"><img src="public/images/sub/icon_arrow1.svg" alt="화살"></span>
	                                        <span class="gooey"></span>
	                                    </button>
                                    </div>
                                </div>
                            </form>
                            <!--<div class="articel-agree">
                                <input type="checkbox" id="chk1" class="ipt">
                                <label for="chk1"><span>개인정보 수집과 이용에 동의할게요!</span></label>
                           </div>-->
                        </div>
                        <div class="ai">
                            <span class="ai-img" style="background-image:url('public/images/sub/svs3_1.svg')" alt="일러스트"></span>
                        </div>
                        <div class="ai-mobile">
                            <img src="public/images/sub/svs3_1_m.svg" class="ai-mobile-img" alt="일러스트">
                        </div>
                        <span class="bg-gooey">
                            <!-- <img src="/public/images/sub/svs3_bg2.svg" alt="백그라운드"> -->
                            <svg xmlns="http://www.w3.org/2000/svg" width="812" height="894" viewBox="0 0 812 894">
                                <defs>
                                    <style>.svs3_bg2{fill:#ffcda8;}</style>
                                </defs>
                                <path class="svs3_bg2">
                                    <animate repeatCount="indefinite" attributeName="d" dur="10s" 
                                    values="M.4,518.1C3.81,400.42,73.669,294.834,166.03,205.36,233.192,140.3,312.423,83.752,386.4,37.5,524.514-48.8,638.424,25.638,713.51,156.2c41.034,71.349,70.461,159.64,85.79,247.5,23.3,133.585,14.955,251.424-36.484,338.724C718.848,817.045,643.069,869.2,528.4,889.2c-131.6,23-240.2-48.1-338.1-123.9C103.4,698.2-3,636.5.4,518.1Z;

                                    M.4,518.1C3.81,400.42,125.96,332.87,218.321,243.4c67.162-65.063,94.1-159.644,168.079-205.9C524.514-48.8,638.424,25.638,713.51,156.2c41.034,71.349-15.328,191.336,0,279.2,23.3,133.585,100.744,219.728,49.306,307.028C718.848,817.045,643.069,869.2,528.4,889.2c-131.6,23-300.179,4-398.079-71.8C43.421,750.3-3,636.5.4,518.1Z;
                                    
                                    M.4,518.1C3.81,400.42,73.669,294.834,166.03,205.36,233.192,140.3,312.423,83.752,386.4,37.5,524.514-48.8,638.424,25.638,713.51,156.2c41.034,71.349,70.461,159.64,85.79,247.5,23.3,133.585,14.955,251.424-36.484,338.724C718.848,817.045,643.069,869.2,528.4,889.2c-131.6,23-240.2-48.1-338.1-123.9C103.4,698.2-3,636.5.4,518.1Z"/>
                                </path>
                            </svg>
                        </span>
                    </div>     
                    ...
                    if (input_val != '') {
                        switch (form_element) {
                            case 'wf_company_name' :
                                if ($('#wf_nickname').css('display') == 'none') {
                                    $('#wf_nickname').show('slow').slideDown('fast');
                                    $('#wf_nickname').removeClass('success');
                                }
                            break;
                        ...
                        switch (form_element) {
                            case 'wf_company_name' :
                                if (frm.tel.value == '' && frm.email.value == '' && frm.post_content.value == '') {
                                    frm.tel.value = '';
                                    $('#wf_nickname', '#wf_tel, #wf_email, #wf_content').removeClass('success');
                                    $('#wf_nickname', '#wf_tel, #wf_email, #wf_content').hide('slow').slideUp('fast');
    ...
    $("input:text[numberOnly]").on("keyup", function() {
        ...
        if (frm.email.value == '') {
            ...
            if (telValidator(frm.tel.value) !== true) {
                ...
                frm.post_title.value = frm.email.value + '님의 프로젝트 문의입니다';
                frm.submit();
            }
        }
    }); 
